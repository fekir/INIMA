...
Pro tip: create a config file like
...
----
{
	...
	"vram": "32",
	"headless": "true",
	"iso_checksum": "b58b06599830583594288cc779d93c7f8abaa685",
	"iso_checksum_type": "sha1",
	"iso_url": "/home/df0/Software/windows/microsoft/windows/en_windows_10_consumer_editions_version_20h2_updated_dec_2020_x64_dvd_bde6c5a2.iso",
	...
	"choco_packages": "",
	"cygwin_packages": "",
	"hardening": "association",
	"cleanup": ""
}
----

and use `-on-error=ask` when experimenting:

[source, sh]
----
packer build -on-error=ask -var-file=./template/windows_base-10.json template/virtualbox/windows_base.json
----
