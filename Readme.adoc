...
packer build template/virtualbox/debian-packages.json
vboxmanage import out/virtualbox/debian-packages/debian.ovf
----

----
packer build template/virtualbox/windows-base.json
packer build template/virtualbox/windows-setup.json
vboxmanage import out/virtualbox/windows-setup/windows.ovf
----
